...
const file_proto_benchmark_proto_rawDesc = "" +
	...
	"\ttimestamp\x18\x02 \x01(\x03R\ttimestamp2F\n" +
	"\vPingService\x127\n" +
	"\x04Ping\x12\x16.benchmark.PingRequest\x1a\x17.benchmark.PingResponseB)Z'github.com/seuuser/grpc-benchmark/protob\x06proto3"
...
var file_proto_benchmark_proto_depIdxs = []int32{
	0, // 0: benchmark.PingService.Ping:input_type -> benchmark.PingRequest
	1, // 1: benchmark.PingService.Ping:output_type -> benchmark.PingResponse
